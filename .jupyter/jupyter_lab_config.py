...
#  Default: ''
c.LabServerApp.user_settings_dir = '/workspaces/jypitercontainer/.jupyter/server/user-settings'
...
c.LabApp.user_settings_dir = '/workspaces/jypitercontainer/.jupyter/lab/user-settings'
